...
<html lang="id">
  <head>
    ...
    <title>Petgroomingsoq - <?php echo $product_name; ?></title>
...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="../../assets/images/banner2.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-2">
				<div class="title-page">Product Details</div>
			</div>
			<p class="text-center text-white"><?php echo $product_name; ?></p>
		</div>
	</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-6">
						...
						<div class="media-detail">
							<img src="../../assets/images/product_image/<?php echo $product_image; ?>" alt="" class="img-fluid">
						</div>
					...
					<div class="col-12 col-sm-6 col-md-6">
						<div class="single-shop">
							...
							<div class="price">Rp.<?php echo $product_price; ?>0</div>
							<div class="">Dijual dari toko : <?php echo $namaToko; ?></div>
							<div class="">Nomor pemilik toko : <?php echo $nomorToko; ?></div>
							<a href="https://api.whatsapp.com/send?phone=<?php echo forcing($nomorToko); ?>&text=Apakah <?php echo $product_name; ?> masih ada?" target="_blank" class="btn btn-primary mt-4 mb-4">Hubungi penjual</a>
						</div>
					</div>
					...
					<div class="col-12 col-sm-12 col-md-12">
						...
						<div class="rs-tabs">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
									...
									<p class="responsive"><?php echo $product_description; ?></p>
								</div>
							</div>
						</div>
						<!-- end tabs -->
						...
						<div class="similar-box">
							<h4 class="title-heading">Produk lainnya</h4>
							<div class="row">
								
                            <?php
                                $sqlStatement = "SELECT * FROM tb_product WHERE product_status = 'Tampilkan' ORDER BY product_id DESC LIMIT 3";
