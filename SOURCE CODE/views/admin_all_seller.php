...
<html lang="en">
    <head>
        ...
        <title>Petgroomingsoq - Seller</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Data Seller</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Tambah / Ubah Akun Seller</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="admin_main">
                                    <input type="hidden" id="main_admin" value="add_seller">
                                    <input type="hidden" id="admin_id" value="0">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama_admin">Nama Seller</label>
                                                <input type="text" class="form-control" id="nama_admin" placeholder="Nama Seller">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $sqlStatement = "SELECT * FROM tb_admin WHERE admin_level = 'seller' ORDER BY admin_id DESC";
                                            ...
                                            <td><?php echo $row['admin_adress']; ?></td>
                                            <td>
                                                <button type="button" class="btn bg-gradient-primary btn-sm edit_admin" name="<?php echo $row['admin_name']; ?>" value="<?php echo $row['admin_id']; ?>"><i class="fa fa-edit"></i> Ubah</button>
                                                <button type="button" class="btn bg-gradient-danger btn-sm delete_admin" name="<?php echo $row['admin_name']; ?>" value="<?php echo $row['admin_id']; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                            </td>
                                        </tr><?php } ?>
                                    </tbody>
                                    <tfoot>
