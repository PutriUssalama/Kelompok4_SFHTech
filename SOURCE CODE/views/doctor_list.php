...
<html lang="id">
  <head>
    ...
    <title>Petgroomingsoq - Doctor</title>
...
<body>
	...
	<div class="section banner-page" data-background="../assets/images/banner1.jpg">
		<div class="content-wrap pos-relative">
			...
			<p class="text-center text-white">Buat panggilan dengan mereka.</p>
		</div>
	</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-12 col-sm-9 col-md-9">
						...
						<div class="row">
                            <?php
                                $sqlStatement = "SELECT * FROM tb_doctor ORDER BY doctor_id DESC LIMIT 500";
							...
							<div class="col-sm-4 col-md-4">
								<div class="rs-shop-box mb-5">
									<div class="media">
                                        <a href="#"><img src="../assets/images/profile_image/<?php echo $row['doctor_profile_img']; ?>" alt="<?php echo $row['doctor_name']; ?>" class="img-fluid"></a>
									</div>
									<div class="body-text">
										<h4 class="title"><a href="#"><?php echo $row['doctor_name']; ?></a></h4>
										<div class="meta">
											<span class="price"><?php echo $row['doctor_telp']; ?></span>
										</div>
									</div>
								</div>
							</div>
