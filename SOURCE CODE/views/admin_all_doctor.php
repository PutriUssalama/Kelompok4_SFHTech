...
<html lang="en">
    <head>
        ...
        <title>Petgroomingsoq - Doctor Accounts</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Tambah / Ubah Akun Dokter</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="doctor_main">
                                    <input type="hidden" id="main_doctor" value="add">
                                    <input type="hidden" id="doctor_id" value="0">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama_dokter">Nama</label>
                                                <input type="text" class="form-control" id="nama_dokter" placeholder="Nama Dokter">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea maxlength="50" class="form-control" id="info"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $sqlStatement = "SELECT * FROM tb_doctor ORDER BY doctor_id DESC";
                                            $runStatement = $conn->query($sqlStatement);
                                            $dataStatement = $runStatement->fetchAll();
                                            foreach($dataStatement as $row){
                                                ?><tr>
                                            <td><?php echo $row['doctor_name']; ?></td>
                                            <td><?php echo $row['doctor_telp']; ?></td>
                                            <td><?php echo $row['doctor_email']; ?></td>
                                            <td><?php echo $row['doctor_adress']; ?></td>
                                            <td><img src="../../assets/images/profile_image/<?php echo $row['doctor_profile_img']; ?>" name="<?php echo $row['doctor_name']; ?>" title="<?php echo $row['doctor_name']; ?> Profile" width="60" height="60"></td>
                                            <td><?php echo $row['doctor_info']; ?></td>
                                            <td>
                                                <button type="button" class="btn bg-gradient-primary btn-sm edit_doctor" name="<?php echo $row['doctor_name']; ?>" value="<?php echo $row['doctor_id']; ?>"><i class="fa fa-edit"></i> Ubah</button>
                                                <button type="button" class="btn bg-gradient-danger btn-sm delete_doctor" name="<?php echo $row['doctor_name']; ?>" value="<?php echo $row['doctor_id']; ?>"><i class="fa fa-trash"></i> Hapus</button>
                                            </td>
                                        </tr><?php } ?>
                                    </tbody>
                                    <tfoot>
