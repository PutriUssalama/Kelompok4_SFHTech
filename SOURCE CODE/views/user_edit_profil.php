                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                <form id="user_main">
                                    <input type="hidden" id="main_user" value="profiling">
                                    <input type="hidden" id="user_id" value="<?php print($did); ?>">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama_pelanggan">Nama</label>
                                                <input type="text" class="form-control" id="nama_pelanggan" value="<?php print($nama); ?>" placeholder="Nama Dokter">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="no_telp">No Telp</label>
                                                <input type="number" class="form-control" id="no_telp" value="<?php print($telp); ?>" placeholder="Nomor Telepon">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea maxlength="50" class="form-control" id="info"><?php print($info); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
