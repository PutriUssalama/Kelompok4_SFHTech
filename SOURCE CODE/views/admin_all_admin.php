...
<html lang="en">
    <head>
        ...
        <title>Petgroomingsoq - Admin Accounts</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Tambah / Ubah Akun Admin</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="admin_main">
                                    <input type="hidden" id="main_admin" value="add">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $sqlStatement = "SELECT * FROM tb_admin ORDER BY admin_id DESC";
