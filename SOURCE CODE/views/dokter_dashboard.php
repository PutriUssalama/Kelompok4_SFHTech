            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="../../assets/images/profile_image/<?php print($fotoProfile) ?>" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
                            ...
                            <div class="col-12 col-sm-6 col-md-12">
                                <div class="info-box mb-3">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Konsultasi yang sudah dibalas</span>
                                        <?php
                                            $sqlPrep = "SELECT * FROM tb_consultant WHERE reply_by IS NOT NULL";
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Konsultasi yang belum dibalas</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            $sqlStatement = "SELECT * FROM tb_consultant WHERE reply_by IS NULL ORDER BY consultant_id DESC";
                                            $runStatement = $conn->query($sqlStatement);
                                            $dataStatement = $runStatement->fetchAll();
                                            foreach($dataStatement as $row){
                                                ?><tr>
                                            <td><?php echo $row['consultant_by']; ?></td>
                                            <td id="cons"><?php echo $row['consultant']; ?></td>
                                            <td>
                                                <button type="button" class="btn bg-gradient-primary btn-sm reply" value="<?php echo $row['consultant_id']; ?>"><i class="fa fa-edit"></i> Balas</button>
                                            </td>
                                        </tr><?php } ?>
                                    </tbody>
                                    <tfoot>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Balas konsultasi</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form id="consultant_reply">
                    <input type="hidden" id="cid" value="0">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="consultant">Konsultasi</label>
                            <textarea disabled='disabled' class="form-control" id="consultant" placeholder="Konsultasi"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="replys">Balasan</label>
                            <textarea class="form-control" id="replys" placeholder="Balasan anda"></textarea>
                        </div>
                    </div>
            </div>
