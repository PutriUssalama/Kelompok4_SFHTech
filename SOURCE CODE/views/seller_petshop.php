                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Edit Petshop</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Edit Petshop</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="petshop_main">
                                    <input type="hidden" id="main_petshop" value="edit">
                                    <input type="hidden" id="petshop_id" value="<?php echo $data['petshop_id'] ?>">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                            <label for="petshop_name">Nama Petshop</label>
                                            <input type="text" class="form-control" id="petshop_name" value="<?php echo $data['petshop_name'] ?>" placeholder="Nama Petshop">
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="petshop_telp" value="<?php echo $data['petshop_telp'] ?>" placeholder="Nomor Telp Petshop">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="petshop_desc" placeholder="Deskripsi Petshop"><?php echo $data['petshop_info'] ?></textarea>
                                        </div>
                                        </div>
                                        <div class="col-sm-6">
                                        <!-- textarea -->
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="petshop_adress" value="<?php echo $data['petshop_adress'] ?>" placeholder="Alamat Petshop">
                                        </div>
                                        </div>
                                        <div class="col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary productAction">Simpan</button>
                                </form>
                            </div>
                            <!-- /.card-body -->
                            </div>
