...
<html lang="id">
  <head>
    ...
    <title>Petgroomingsoq - Solusi Peliharaan Anda!</title>
	...
	<div class="section banner-page" data-background="../assets/images/banner1.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-2">
				<div class="title-page">Petshop</div>
			</div>
			<p class="text-center text-white">Cari petshop di daerah tertentu.</p>
		</div>
	</div>
			...
			<div class="container">
			    <nav aria-label="breadcrumb">
				  <ol class="breadcrumb ">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Petshop</li>
				  </ol>
				</nav>					
			</div>
		</div>
					...
					<div class="col-12 col-sm-9 col-md-9">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								...
								<p class="subheading">Beli dan cari petshop di sekitar anda.</p>
							</div>
						</div>					
						<div class="row">
                            <?php
                                $sqlStatement = "SELECT * FROM tb_petshop ORDER BY petshop_id DESC LIMIT 500";
							...
							<div class="col-sm-4 col-md-4">
								<div class="rs-shop-box mb-5">
									<div class="media">
                                        <a href="<?php echo $row['petshop_adress']; ?>" target="_blank" class="price"><img src="../assets/images/product_image/<?php echo $row['petshop_img']; ?>" alt="<?php echo $row['petshop_name']; ?>" class="img-fluid"></a>
									</div>
									<div class="body-text">
										<h4 class="title"><a href="<?php echo $row['petshop_adress']; ?>" target="_blank"><?php echo $row['petshop_name']; ?></a></h4>
										<div class="meta">
											<a href="<?php echo $row['petshop_adress']; ?>" target="_blank" class="price">Map</a>
                                            <br><small><?php echo $row['petshop_telp']; ?></small>
										</div>
									</div>
								</div>
							</div>
